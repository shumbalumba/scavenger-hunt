  ...
  return (
    <div className="relative group w-full">
      <input
        ...
        data-slot="input"
        className={cn(
          "bg-gray-900 border-2 border-yellow-500/70 w-full rounded-md px-3 py-2 font-medium text-2xl",
      ...
      <div
        className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 h-px bg-yellow-400/50 transition-all duration-300 rounded-full blur-[2px] ${isFocused ? "w-5/6 opacity-100" : "w-0 opacity-0 group-hover:w-2/3 group-hover:opacity-50"}`}
      ></div>
    </div>
  );
}
